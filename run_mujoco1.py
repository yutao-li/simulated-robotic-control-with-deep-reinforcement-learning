...
directory = r'/home/masterlee/reinforcement learning/saved model/'
...
def learn(sess, env_id, env, policy_fn, *,
    ...
    U.initialize()
    adam.sync()
    tf.train.Saver().restore(sess, directory + env_id + '/model.ckpt')
...
def main():
    ...
    if t == True:
        ...
        test(parser.parse_args().env, seed=0)
